...
class FPSCounter:
    ...
    def get_fps(self):
        ...
        return 0 if total_time == 0 else len(self.frame_times) / sum(self.frame_times)
...
class MyGame:
    ...
    def add_coins(self):
        ...
        # Create the coins
        for _ in range(COIN_COUNT_INCREMENT):
    ...
    def update(self, _delta_time):
        ...
        for sprite in self.coin_list:
            ...
            if sprite.rect.x < 0 or sprite.rect.x > SCREEN_WIDTH:
                sprite.change_x *= -1
        ...
        if total_program_time > self.last_fps_reading:
            ...
            if total_program_time > 5 and total_program_time % 2 == 1:
                # Take timings
